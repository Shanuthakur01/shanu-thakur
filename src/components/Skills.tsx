        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          >
            ...
            {skillCategories.map((category, index) => (
              <motion.div 
                key={index} 
                className="group bg-white/80 dark:bg-slate-700/80 backdrop-blur-sm rounded-xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-slate-200 dark:border-slate-600 hover:border-transparent relative overflow-hidden"
